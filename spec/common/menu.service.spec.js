describe('The menu service', function() {
  ...
  var testData = {
    allMenuItems: [
      {
        ...
        short_name: "A1",
        name: "Egg Drop Soup",
        description: "chicken breast with egg drop",
        price_small: 2.25,
        price_large: 4.5,
    ...
    aCategory: {
      ...
      short_name: "A",
      name: "Lunch",
      special_instructions: "Monday-Friday 11:15am-3:00pm. Served with your choice of rice (Vegetable Fried RIce, Steamed Rice, Brown Rice), AND EITHER soup (Hot & Sour, Wonton, Vegetable, Egg Drop, Chicken Corn Soup) OR veggie egg roll. $1.00 extra to have both soup and egg roll.",
